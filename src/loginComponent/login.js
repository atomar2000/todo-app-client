...
function GoogleSignin(props) {
    ...
    function onSuccess(res){
        ...
        fetch('http://localhost:8080/user', {
          ...
          .catch(error => {
            console.log('something went wrong when sending user info: ',error);
          });
    }
